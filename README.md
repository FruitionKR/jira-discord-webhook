...
1. Vercel Cron이 매일 UTC 23:20에 `GET /api/cron-check-dates`를 호출합니다.
2. 이 시간은 한국시간 KST 08:20입니다.
...
| 이슈 삭제 | 빨간색 | 삭제된 이슈 |
| 오늘 시작일 | 초록색 | 매일 KST 08:20 D-Day 알림 |
| 오늘 마감일 | 빨간색 | 매일 KST 08:20 D-Day 알림 |
